...
class SecurityHeadersMiddleware
{
	...
	public function before(array $params): void
	{
		...
		$csp = "default-src 'self'; script-src 'self' https://cdn.jsdelivr.net 'unsafe-eval' 'nonce-{$nonce}'; style-src 'self' https://cdn.jsdelivr.net {$tracyCssBypass}; img-src 'self' data:;";
